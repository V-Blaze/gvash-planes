    ...
    <div className="w-full py-10 mb-24 sm:px-[10%] px-5">
      <div className="w-full py-5 sm:pt-5 sm:pb-32 flex">
        ...
        <div>
          ...
          <p className='bg-gray-100'>Plane type: {plane.plane_type}</p>
          <p>Description: {plane.description}</p>
          <p className='bg-gray-100'>Price: {plane.price} $</p>
          <p>Model: {plane.model} km</p>
          <p className='bg-gray-100'>Year of manifacture: {plane.year_of_manifacture}</p>
          <p>Life span: {plane.life_span} years</p>
          <p className='bg-gray-100'>Fees: {plane.life_span} $</p>
        </div>
      </div>
    </div>
  );
